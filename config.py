...
net_arg.add_argument('--z_num', type=int, default=1000, choices=[64, 128])
...
train_arg.add_argument('--d_lr', type=float, default=0.2e-4)
train_arg.add_argument('--g_lr', type=float, default=9e-4)
